...
MicroPython module: https://docs.micropython.org/en/vab847696a/library/rp2.html
...
class StateMachine():
    ...
    def irq(self, handler=None, trigger=0|1, hard=False) -> Incomplete:
        ...
        """
        ...
def asm_pio(*, out_init=None, set_init=None, sideset_init=None, in_shiftdir=0, out_shiftdir=0, autopush=False, autopull=False, push_thresh=32, pull_thresh=32, fifo_join=PIO.JOIN_NONE) -> Incomplete:
    """
